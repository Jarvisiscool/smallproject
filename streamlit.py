...
DATA_URL = (r'C:\Users\navee\Desktop\Python\Tweets.csv')
...
select = st.sidebar.selectbox('Visualiaation type', ['Histogram', 'Pie Chart'], key='1')
...
modified_data = data[data['tweets_created'].dt.hour == hour]
